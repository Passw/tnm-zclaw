...
zclaw is written in C and runs on ESP32 boards with a strict "all-in" firmware budget target of **<= 888 KB** on the default build. It supports scheduled tasks, GPIO control, persistent memory, and custom tool composition through natural language.

The **888 KB** cap is all-in firmware size, not just app code. 
